...
* improve structure and workflows
* document decisions
* propose refinements
...
* is clearly organized and named
* has a stable ID
* includes a YAML metadata file
* is listed in the archive inventory
...
* a task list
* a YAML repository (metadata + inventory)
...
* can work independently and align with a system
